  ...
  return (
    ...
    <div className='w-full h-screen duration-200' style={{backgroundColor:color}}>
      <div className='fixed flex flex-wrap justify-center bottom-12 inset-x-0 px-2'>
        ...
        <button className='outline-none px-4 py-1 rounded-full text-white' style={{backgroundColor:'gray'}} onClick={()=> setColor("gray")} >Grey </button>
        <button className='outline-none px-4 py-1 rounded-full text-white' style={{backgroundColor:'hotpink'}} onClick={()=> setColor("hotpink")} >Hotpink </button>
